...
class PollsControllerTest < ActionController::TestCase
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post :create, poll: { allergy: @poll.allergy, email: @poll.email, money: @poll.money, time: @poll.time }
    end
  ...
  test "should update poll" do
    put :update, id: @poll, poll: { allergy: @poll.allergy, email: @poll.email, money: @poll.money, time: @poll.time }
    assert_redirected_to poll_path(assigns(:poll))
  end
