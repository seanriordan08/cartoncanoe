...
def ensure_not_referenced_by_any_line_item
  ...
  attr_accessible :description, :image_url, :price, :title, :unit_of_measure, :portion_size, :brand, :priority, :scalable, :not_for_sale
  
  validates :title, :description, :image_url, :unit_of_measure, :presence => true
